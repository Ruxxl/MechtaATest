...
describe('Купоны — общие элементы и именование страницы', () => {
    ...
    // TC-КУ-1 — BUG-018 ИСПРАВЛЕН (проверено живьём 2026-08-11, файл бага
    // и Jira-тикет не были заведены до фикса — раздел был закрыт раньше,
    // чем в проекте появился обязательный флоу "баг найден → сразу Jira"):
    // раньше именование в крошке и заголовке расходилось, теперь совпадает.
    ...
    // раньше пункт «Купоны» вообще не подсвечивался на своей же странице
    // (в отличие от orders/bonuses/cards), теперь подсвечен.
